        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="email" name="email" placeholder="food123@gmail.com" class="input-responsive" required>
                    ...
                    <input type="submit" name="submit" value="Confirm Order" class="btn btn-primary">
                        ...
                        if(isset($_POST['submit']))
                        {
                            ...
                            $status = "Ordered"; //Oered , on delivery , delivered, cancelled
                            ...
                            //Save the oeder in database
                            //Create SQL to save tha data
